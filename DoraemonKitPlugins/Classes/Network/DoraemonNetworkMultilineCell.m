//
//  DoraemonNetworkMultilineCell.m
//  ZZHLBidder
//
...
@interface DoraemonNetworkMultilineCell ()
@property (nonatomic) BOOL constraintsUpdated;
@end

@implementation DoraemonNetworkMultilineCell
...
@implementation NetworkMultilineDetailCell
