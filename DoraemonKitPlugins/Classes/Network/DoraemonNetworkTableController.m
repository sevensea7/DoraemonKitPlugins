//
//  DoraemonNetworkTableController.m
//  ZZHLBidder
//
...
CGFloat const kDebounceInstant = 0.f;
CGFloat const kDebounceFast = 0.05;
CGFloat const kDebounceForAsyncSearch = 0.15;
CGFloat const kDebounceForExpensiveIO = 0.5;

@interface DoraemonNetworkTableController ()
...
@implementation DoraemonNetworkTableController
...
- (id)initWithStyle:(UITableViewStyle)style {
    ...
    if (self) {
        _searchBarDebounceInterval = kDebounceFast;
...
- (void)makeKeyboardAppearNow {
    ...
    [UIApplication.sharedApplication.delegate.window addSubview:kDummyTextField];
