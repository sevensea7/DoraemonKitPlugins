...
@interface WMNetworkRecorder : NSObject

/// In general, it only makes sense to have one recorder for the entire application.
@property (nonatomic, readonly, class) WMNetworkRecorder *defaultRecorder;
...
/// Array of NetworkTransaction objects ordered by start time with the newest first.
